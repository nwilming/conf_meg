...
#
# Requires neuropythy: pip install neuropythy
# Made some minor adjustments to have the script run outside of the docker container.
SUBJECTS_DIR="/home/nwilming/fs_subject_dir"

# This is the location of the template:
TEMPLATE_DIR="/home/nwilming/conf_analysis/required/apply_occ_wang/subjects/fsaverage_sym/surf"
...
WANG_ATLAS_LH_MGZ="/home/nwilming/conf_analysis/required/apply_occ_wang/lh.wang2015_atlas.mgz"
WANG_ATLAS_RH_MGZ="/home/nwilming/conf_analysis/required/apply_occ_wang/rh.wang2015_atlas.mgz"
