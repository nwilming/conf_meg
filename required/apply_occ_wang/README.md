...
This docker applies the V1, V2, and V3 anatomical template of retinotopy from
...
Additionally, the Docker may be run as follows to view the license file
...
### Dependencies
This docker depends on the ubuntu:trusty Docker; it does not depend on
FreeSurfer in any direct way and may be run without it even installed on your
own computer; however, FreeSurfer is required to perform the `mri_convert` step
listed above.
